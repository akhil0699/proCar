...
var editor = renderer["a" ].create('<div class="note-editor note-frame card"/>');
var toolbar = renderer["a" ].create('<div class="note-toolbar card-header" role="toolbar"/>');
...
var editable = renderer["a" ].create('<div class="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>');
...
var dropdown = renderer["a" ].create('<div class="note-dropdown-menu dropdown-menu" role="list">', function ($node, options) {
...
var dropdownCheck = renderer["a" ].create('<div class="note-dropdown-menu dropdown-menu note-check" role="list">', function ($node, options) {
  var markup = Array.isArray(options.items) ? options.items.map(function (item) {
    var value = typeof item === 'string' ? item : item.value || '';
    var content = options.template ? options.template(item) : item;
...
var ui_checkbox = renderer["a" ].create('<div class="form-check"></div>', function ($node, options) {
...
var ui_ui = function ui(editorOptions) {
  return {
    ...
    button: function button($node, options) {
      return renderer["a" ].create('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1">', function ($node, options) {
